							...
							rt_uint8_t *stack_addr)
{
	...
	/* 获取栈顶指针 rt_hw_stack_init 在调用的时候，传给stack_addr的是(栈顶指针-4) */
	...
	/* 将stack指针强制转换为stack_frame类型后存到stack_frame */
	...
	stack_frame->exception_stack_frame.r2 = 0;							/* r1 */
	stack_frame->exception_stack_frame.r3 = 0;							/* r1 */
